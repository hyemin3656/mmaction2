...
vis_backends = [
    ...
    dict(
        ...
        define_metric_cfg=[
            ...
            dict(name='val_loss', step_metric='epoch', summary='min'),
            dict(name='val_loss_ctc', step_metric='epoch', summary='min'),
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=200, val_begin=5, val_interval=5) #20
